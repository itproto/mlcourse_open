...
image_name = 'my-jup'  # 'festline/mlcourse_open'


def main():
    parser = argparse.ArgumentParser(
        add_help=True, description='Run docker image.')
    parser.add_argument("--docker_tag", "-t",
                        default=image_name, help='Docker image tag')
    parser.add_argument("--net_host", action='store_true',
